...
function contactForm(message, statusMsg, contactForm, contactInput) {
  contactForm.addEventListener('submit', function (event) {
    ...
    sendData(contactForm, contactInput).then(function () {
...
function form(message, statusMsg, form, input) {
  form.addEventListener('submit', function (event) {
    event.preventDefault();
    sendData(form, input).then(function () {
      statusMsg.innerHTML = message.loading;
    }).then(function () {
      statusMsg.innerHTML = message.success;
    }).catch(function () {
...
function timer(deadline, hours, minutes, seconds) {
  ...
  function setClock() {
    ...
    function updateClock() {
      var data = getTimeRemaning(deadline);
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var tabs = __webpack_require__(/*! ./modules/tabs.js */ "./src/js/modules/tabs.js"),
      ...
      calc = __webpack_require__(/*! ./modules/calc.js */ "./src/js/modules/calc.js"); // info tabs
  ...
  tabs(info, tab, tabName, tabContent); // deadline timer
  ...
  timer(deadline, hours, minutes, seconds); // modal window
  ...
  modal(moreBtn, overlay, closeBtn, descrBtn, animationName); // form sending
  ...
  form(message, statusMsg, formElem, input); // contact form sending

  var contactFormElem = document.querySelector('#form'),
      contactInput = contactFormElem.getElementsByTagName('input');
  contactForm(message, statusMsg, contactFormElem, contactInput); // slider
  ...
  slider(slideIndex, slides, prev, next, dotsWrapper, dots, dotActiveName); // calc
